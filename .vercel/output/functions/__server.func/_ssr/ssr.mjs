...
import { n as runWithStartContext, t as getStartContext } from "./async-local-storage-Bgyd8gHc.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CETVSRKK.mjs");
...
async function loadEntries() {
	const routerEntry = await import("./router-DAQpfJpu.mjs");
	return {
		startEntry: await import("./start-h4RPF5bp.mjs"),
		routerEntry
	};
}
function getEntries() {
