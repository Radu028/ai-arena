//#region node_modules/.nitro/vite/services/ssr/assets/arena-COEnf_2-.js
var SESSION_THEMES = [
	"comedy",
	"debate",
	"eli5",
...
var MAX_MODELS_PER_SESSION = AVAILABLE_MODELS.length;
new Map(AVAILABLE_MODELS.map((model) => [model.key, model]));
//#endregion
export { THEME_COPY as i, MAX_MODELS_PER_SESSION as n, SESSION_THEMES as r, AVAILABLE_MODELS as t };
